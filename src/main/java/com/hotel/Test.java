...
import com.hotel.entity.Camera.Balcone;
...
import com.hotel.entity.Prenotazione.Fonte;
import com.hotel.entity.Prenotazione.Pagato;
...
//		cameraService.saveCamera(camera1001);
		...
		Prenotazione prenotazione = prenotazioneService.getPrenotazioneById(3L);
		prenotazione.getConsumazioni().forEach(consumazioneService::deleteConsumazione);
	}
}